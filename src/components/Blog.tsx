...
export default function Blog() {
  return (
    <div className="pl-24 my-20  max-w-screen-lg bg-white pb-20 ">
      <div className="max-w-screen-md">
        <div className="mx-auto max-w-screen-md grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          {posts.map((post) => (
            <article
              key={post.id}
              className="pb-10 max-w-screen-md items-center justify-center"
            >
