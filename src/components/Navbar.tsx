...
const Navbar: React.FC<SidebarProps> = () => {
    return (
        ...
        /* > */
        <div
            className="mr-auto pr-4 flex shrink-0 grow-0 justify-around gap-4 border-t border-gray-200 bg-white/50 p-2.5 shadow-lg backdrop-blur-lg
        ...
        >
            <div className="flex flex-col p-4">
                ...
                <ul>
                    <a href="/">
                        <li className="text-l pt-3 mb-2 px-4 py-2 text-left rounded hover:bg-slate-100 focus:outline-none focus:bg-slate-500">Home</li>
                    </a>
                    <a href="../pages/projects.tsx">
                        <li className="text-l pt-3 mb-2 px-4 py-2 text-left rounded hover:bg-slate-100 focus:outline-none focus:bg-slate-500">Projects</li>
                    </a>
                </ul>
